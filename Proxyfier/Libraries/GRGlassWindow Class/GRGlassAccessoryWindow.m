...
- (void)drawTitle
{
    ...
    NSDictionary *titleAttributes = @{NSFontAttributeName: [NSFont fontWithName:@"Lato" size:14.0],
    ...
    NSDictionary *subtitleAttributes = @{NSFontAttributeName: [NSFont fontWithName:@"Lato" size:12.0], NSForegroundColorAttributeName : [NSColor colorWithCalibratedWhite:0.3 alpha:0.8]};
